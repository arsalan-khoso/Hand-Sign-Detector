...
public class signLanguageClass {
    ...
    signLanguageClass(Button add_button, Button clear_button, TextView change_text, AssetManager assetManager, String modelPath, String labelPath, int inputSize, String classification_model, int classification_input_size) throws IOException{
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Rect cropped_n = new Rect((int)x1, (int)y1, (int)w1, (int)h1 );

                Mat cropped = new Mat(rotated_mat_image, cropped_n).clone();
